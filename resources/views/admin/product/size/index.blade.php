@extends('layouts.main', ['title' => ('Product Size Manage'), 'modal' => 'xl',])
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Or Manage Product Size</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div id="accordion">
                ...
                @can('brand.create')
                    <div class="card card-info">
                        ...
                        <div id="create" class="panel-collapse collapse in">
                            <div class="card-body">
                                <form action="{{ route('admin.product-initiazile.size.store') }}" method="post" id="content_form">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input style="text-transform: uppercase;" type="text" name="size_name" id="size_name" class="form-control" placeholder="Enter Product Size Name" required>
                                        </div>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea name="size_details" id="size_details" class="form-control" cols="30" rows="2" placeholder="Enter Size Description"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div id="list" class="panel-collapse collapse">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered content_managment_table" data-url="{{ route('admin.product-initiazile.size.datatable') }}">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
...
<script src="{{ asset('js/pages/product/size.js') }}"></script>
@endpush
