@extends('layouts.main', ['title' => ('Product Category Manage'), 'modal' => 'xl',])
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Or Manage Product Category</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div id="accordion">
                ...
                @can('customer.create')
                    <div class="card card-info">
                        ...
                        <div id="create" class="panel-collapse collapse in">
                            <div class="card-body">
                                <form action="{{ route('admin.product-initiazile.category.store') }}" method="post" id="content_form">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select data-parsley-errors-container="#status_error" required name="status" id="status" class="form-control select" data-placeholder="Select Category Status">
                    ...
                    <div id="list" class="panel-collapse collapse">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered content_managment_table" data-url="{{ route('admin.product-initiazile.category.datatable') }}">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <td>Image</td>
...
<script src="{{ asset('js/pages/product/category.js') }}"></script>
@endpush
