@extends('layouts.main', ['title' => ('Account Diposit Manage'), 'modal' => 'xl',])
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Account Diposit Manage</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('/home') }}"><i class="fa fa-home"
                                aria-hidden="true"></i></a></li>
                    <li class="breadcrumb-item active">Account Diposit</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Create Or Manage Account Diposit</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div id="accordion">
                ...
                {{-- @can('customer.create') --}}
                    <div class="card card-info">
                        ...
                        <div id="create" class="panel-collapse collapse in">
                            <div class="card-body">
                                <form action="{{ route('admin.account.diposit.store') }}" method="post" id="content_form">
                                    @csrf
